...
batch_list={'rdk':['SDTR68A1','SDPA67G1','METAMORPHOSISSANKALP69W','METAMORPHOSISSANKALP68S']}

date={'Monday':'2017-01-02','Tuesday':'2017-01-03','Wednesday':'2017-01-04',
      'Thursday':'2017-01-05','Friday':'2017-01-06','Saturday':'2017-01-07',
      'sunday':'2017-01-08'}  
...
def get_credentials(x):
    ...
    home_dir = os.path.join('C:\\Users\\Binita\\fiitjee', x)
    os.chdir(home_dir)
...
def main(a):
    ...
    for l in batch_list[a]:
        for i in batch[l].items():
            for j in i[1]:
                if j.find('PHYSICS') !=-1 or j.find('P-') !=-1 :
                    x.append(i[0]+j+' '+l)
